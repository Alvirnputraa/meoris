...
export default function OrderDetailClient({ orderId }: { orderId: string }) {
  ...
  if (isLoading) return <main><div className="p-6">Memuat...</div></main>
  if (!user) return <main><div className="p-6">Mengalihkan ke login...</div></main>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 space-y-4 md:space-y-6">
          ...
          <div className="border border-gray-300">
            ...
            <div className="grid grid-cols-2 border-t border-gray-300 text-sm md:text-base">
              ...
              <div className="px-3 md:px-4 py-2 md:py-3 font-body text-gray-800">-</div>
            </div>
          </div>
          ...
          <div className="border border-gray-300 p-4 md:p-5">
            <div className="font-body text-gray-800 text-sm md:text-base space-y-1">
              ...
              <div>Nama Jalan, No. 123</div>
              <div>Kecamatan/Desa</div>
              <div>Jawa Barat</div>
              <div>40123</div>
              <div>Indonesia</div>
              <div className="flex items-center gap-2 mt-2"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.8 19.8 0 0 1 11.19 19a19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.09 4.18 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.12.9.32 1.78.59 2.63a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.45-1.16a2 2 0 0 1 2.11-.45c.85.27 1.73.47 2.63.59A2 2 0 0 1 22 16.92z" fill="currentColor"/></svg> 08xxxxxxxxxx</div>
              <div className="flex items-center gap-2"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm16 2l-8 5-8-5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg> email@example.com</div>
            </div>
          </div>
        </div>
      </section>
