          ...
          <aside className="absolute right-0 top-0 h-full w-80 md:w-96 max-w-[92%] bg-white shadow-2xl p-6 flex flex-col">
            ...
            <div className="pt-4">
              ...
              <div className="mt-4 flex flex-col items-stretch gap-3">
                <a href="#" className="inline-flex items-center justify-center rounded-none border border-black bg-black text-white px-4 py-2 font-body text-sm hover:opacity-90 transition w-full">
                  Checkout
                </a>
