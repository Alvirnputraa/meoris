    ...
    <main>
      ...
      <section className="bg-white py-10 md:py-14">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          {/* Row */}
          <div className="grid grid-cols-12 items-center gap-y-3 px-4 py-4">
            <div className="col-span-6 flex items-center gap-4 min-w-0">
              <button type="button" aria-label="Hapus" className="w-8 h-8 rounded-full border border-gray-300 grid place-items-center text-black hover:bg-gray-50">
                ×
              </button>
              <div className="relative w-16 h-16 overflow-hidden border border-gray-200 bg-gray-100 shrink-0">
                <Image src="/images/test1p.png" alt="Produk" fill sizes="64px" className="object-cover" />
              </div>
              <div className="truncate font-body text-gray-900">Herbal Shampoo</div>
            </div>
            <div className="col-span-2 text-right font-body text-gray-900 flex items-center justify-end">$888.00</div>
            <div className="col-span-2 text-right font-body text-gray-900">1</div>
            <div className="col-span-2 text-right font-body text-gray-900">$888.00</div>
          </div>
          ...
          <div className="grid grid-cols-12 gap-4 items-end">
            <div className="col-span-12 md:col-span-8">
              <div className="flex items-end gap-2 md:gap-3">
                <input type="text" placeholder="Kode Kupon" className="w-56 md:w-72 rounded-md border border-gray-300 px-3 py-2 text-sm text-black placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-black/40" />
                <button type="button" className="rounded-md bg-black text-white px-4 py-2 text-sm hover:opacity-90">TERAPKAN KUPON</button>
              </div>
            </div>
          </div>

          {/* Cart totals */}
          <div className="grid grid-cols-12 gap-8 mt-4 md:-mt-8">
            <div className="col-span-12 md:col-span-6 md:col-start-7">
              <h3 className="font-heading text-2xl text-black mb-4">Total Keranjang</h3>
              ...
              <div className="mt-4">
                <Link href={`/produk/${id}/checkout`} className="inline-flex w-full items-center justify-center rounded-md bg-black text-white px-5 py-3 font-body text-sm md:text-base hover:opacity-90">
                  Checkout
                </Link>
              </div>
            </div>
