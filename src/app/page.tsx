...
export default function Page() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative grid min-h-[60vh] md:min-h-[80vh] grid-cols-2 split-bg pt-[64px] md:pt-0">
        ...
        >
          ...
          {/* Decorative shape on right center, behind content */}
          <div className="hidden md:block pointer-events-none absolute right-0 top-1/2 -translate-y-1/2 translate-x-3 md:translate-x-8 lg:translate-x-12 xl:translate-x-14 z-0">
            <div className="relative w-[400px] h-[400px] md:w-[520px] md:h-[520px] lg:w-[640px] lg:h-[640px] xl:w-[760px] xl:h-[760px]">
              <Image
                src="/images/shape.png"
                alt=""
                fill
                sizes="(min-width: 1280px) 760px, (min-width: 1024px) 640px, (min-width: 768px) 520px, 400px"
                ...
                <div className="mt-10 max-w-[90rem] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-3 gap-y-8 lg:gap-x-6 lg:gap-y-10 xl:gap-x-8 xl:gap-y-12">
                  <div className="flex flex-col gap-3 w-full">
                    ...
                    <div className="text-left">
                      <p className="font-body text-lg md:text-xl text-gray-500">Sock Sneakers Cloud</p>
                      <p className="font-body text-xl md:text-2xl text-black font-semibold">Rp 250.000</p>
                    </div>
                  </div>
                  <div className="flex flex-col gap-3 w-full">
                    <div className="group relative overflow-hidden border border-gray-200 bg-gray-100 aspect-square w-full cursor-pointer">
